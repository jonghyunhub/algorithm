package prepare_coding_test_problem.bruteforce3.BOJ17472;
...
public class BOJ17472B {
    ...
    static ArrayList<EdgeA> edges = new ArrayList<>();
    static int ans = -1;
    static int[][] a;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= groups; i++) {
            for (int j = i + 1; j <= groups; j++) {
                if (bridge[i][j] > 0) {
                    edges.add(new EdgeA(i, j, bridge[i][j]));
                }
            }
        }
